...
class _BuildAllProductCard extends StatefulWidget {
  const _BuildAllProductCard({
    Key? key,
  ...
  @override
  State<_BuildAllProductCard> createState() => _BuildAllProductCardState();
}

class _BuildAllProductCardState extends State<_BuildAllProductCard> {
  bool liked = false;
