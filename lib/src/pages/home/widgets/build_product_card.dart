                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Icon(
                          Icons.favorite,
                          color: liked?Colors.red:_theme.disabledColor,
                        ),
                      ),
                    ],
                  ),
                      ...
                      if (widget.product.discount != 0)
                        Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: (){
                                CartModel cart = new CartModel(productName: widget.product.name, productImage: widget.product.images!.first, price: widget.product.price, qty: 1);
