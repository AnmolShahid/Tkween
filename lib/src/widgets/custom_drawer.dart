                ...
                child: Column(
                  children: [
                    ...
                    ListTile(
                      ...
                      leading:
                          Icon(FeatherIcons.creditCard, color: theme.hintColor),
                    ...
                    ListTile(
                      ...
                      leading:
                          Icon(FeatherIcons.helpCircle, color: theme.hintColor),
                    ...
                    ListTile(
                        contentPadding: EdgeInsets.zero,
                        onTap: () => Get.offAllNamed<dynamic>(Routes.splash)

                        /*Dialogs.showDialogWithLabel(context,
        ...
        children: [
          ...
          ListTile(
            ...
            title: AutoSizeText(AppLocalizations.of(context)!.detail_profile,
                textAlign: TextAlign.right, style: theme.textTheme.headline3),
